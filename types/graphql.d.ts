...
declare enum CriterionModifier {
  /** >= AND <= */
  Between = "BETWEEN",
  /** = */
  Equals = "EQUALS",
...
declare enum IdentifyFieldStrategy {
...
declare enum ImageLightboxDisplayMode {
  FitX = "FIT_X",
  FitXy = "FIT_XY",
  Original = "ORIGINAL",
}

declare enum ImageLightboxScrollMode {
  PanY = "PAN_Y",
  Zoom = "ZOOM",
}
...
declare enum ImportDuplicateEnum {
  Fail = "FAIL",
  Ignore = "IGNORE",
  Overwrite = "OVERWRITE",
}

declare enum ImportMissingRefEnum {
  Create = "CREATE",
  Fail = "FAIL",
  Ignore = "IGNORE",
}
...
declare enum JobStatusUpdateType {
  Add = "ADD",
  Remove = "REMOVE",
  Update = "UPDATE",
}
...
declare enum PluginSettingTypeEnum {
  Boolean = "BOOLEAN",
  Number = "NUMBER",
  String = "STRING",
}
...
declare enum ScrapeContentType {
  Gallery = "GALLERY",
  Group = "GROUP",
  Image = "IMAGE",
  Movie = "MOVIE",
...
declare enum StreamingResolutionEnum {
  /** 4k */
  FourK = "FOUR_K",
  /** 1080p */
  FullHd = "FULL_HD",
